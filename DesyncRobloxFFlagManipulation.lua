...
if CoreGui:FindFirstChild("NexusMinimizeButton") then CoreGui.NexusMinimizeButton:Destroy() end

local gui = Instance.new("ScreenGui")
gui.Name = "NexusDesyncGUI"
...
minimizeGui.Name = "NexusMinimizeButton"
